...
% Non-blind preprint: shows real authors, prints a neutral "Preprint" footer
% (no proceedings/copyright notice) and uses the running title as the header.
\usepackage[preprint]{icml2026}
% Override the style's PDF metadata so no venue string remains in the file.
\hypersetup{pdftitle={The Geometry of Relativity: Context-Relative Scalar Representations in LLMs},
            pdfauthor={Alexander Ayvazyan, Jaehoon Lee, Kiho Park}, pdfsubject={}}
...
\twocolumn[
  ...
  \begin{icmlauthorlist}
    \icmlauthor{Alexander Ayvazyan}{aff1}
    \icmlauthor{Jaehoon Lee}{aff2}
    \icmlauthor{Kiho Park}{aff3}
  \end{icmlauthorlist}

  \icmlaffiliation{aff1}{Independent Researcher}
  \icmlaffiliation{aff2}{Affiliation TBD}
  \icmlaffiliation{aff3}{Affiliation TBD}
  \icmlcorrespondingauthor{Alexander Ayvazyan}{alexander.ayvazyan@gmail.com}
  \icmlkeywords{mechanistic interpretability, representation geometry, language models, gradable adjectives}

  \vskip 0.3in
]

% Prints the author affiliations and the preprint notice at the foot of page 1.
\printAffiliationsAndNotice{}

% Force the real running-head title (the style's length check otherwise reverts it
% to the blind-mode "Title Suppressed" placeholder).
\fancyhead[C]{\small\bfseries The Geometry of Relativity}
...
We use Gemma-2-9B \citep{gemma2_2024} and focus on eight adjective pairs, as shown in \Cref{tab:domains}.\footnote{Code and data to reproduce all experiments and figures in this paper are available at \url{https://github.com/alexayvazyan/geometry-of-relativity}.}
